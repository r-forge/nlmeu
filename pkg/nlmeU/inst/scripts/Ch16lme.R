...
### code chunk: R16.3a
###################################################
getVarCov(fm16.1, individual = "2")   # d_11
...
### code chunk: R16.6
###################################################
VarCorr(fm16.2)                            # d_11,sigma^2
getVarCov(fm16.2,                          # R_i
          type = "conditional",
          individual = "2")
(fm16.2cov <-                              # V_i
   getVarCov(fm16.2,
...
outliers.idx <- 
   within(armd,
          {
          resid.p <- resid(fm16.2, type = "pearson") # Pearson 
          idx <- abs(resid.p) > -qnorm(id/2)         # Indicator
          })
