...
fm18.1 <- update(fm18.1, eval(form1))      # Formula within model fit evaluated (Optional statement) 
...
### code chunk: R18.4
###################################################
## getVarCov(fm18.1)                    # Not implemented
VarCorr(fm18.1)
...
head(prd4Dt)
xyplot (pred4 ~ mathkind, groups = minority,  # Fig. \ref{SiiLMM:predmod4A}
